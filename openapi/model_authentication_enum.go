...
const (
	NONE AuthenticationEnum = "none"
	REQUIRE_AUTHENTICATED AuthenticationEnum = "require_authenticated"
	REQUIRE_UNAUTHENTICATED AuthenticationEnum = "require_unauthenticated"
	REQUIRE_SUPERUSER AuthenticationEnum = "require_superuser"
)
