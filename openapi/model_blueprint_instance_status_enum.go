...
const (
	SUCCESSFUL BlueprintInstanceStatusEnum = "successful"
	WARNING BlueprintInstanceStatusEnum = "warning"
	ERROR BlueprintInstanceStatusEnum = "error"
	ORPHANED BlueprintInstanceStatusEnum = "orphaned"
	UNKNOWN BlueprintInstanceStatusEnum = "unknown"
)
