...
const (
	NEVER_CREATE UserCreationModeEnum = "never_create"
	CREATE_WHEN_REQUIRED UserCreationModeEnum = "create_when_required"
	ALWAYS_CREATE UserCreationModeEnum = "always_create"
)
