...
// checks if the PolicyBindingRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyBindingRequest{}
...
func (o PolicyBindingRequest) ToMap() (map[string]interface{}, error) {
