...
// checks if the PaginatedUserOAuthSourceConnectionList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedUserOAuthSourceConnectionList{}
...
func (o PaginatedUserOAuthSourceConnectionList) ToMap() (map[string]interface{}, error) {
