...
func (a *ProvidersAPIService) ProvidersAllListExecute(r ApiProvidersAllListRequest) (*PaginatedProviderList, *http.Response, error) {
	...
	if r.backchannelOnly != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "backchannel_only", r.backchannelOnly, "")
	}
	if r.ordering != nil {
...
func (a *ProvidersAPIService) ProvidersProxyListExecute(r ApiProvidersProxyListRequest) (*PaginatedProxyProviderList, *http.Response, error) {
	...
	if r.propertyMappingsIexact != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "property_mappings__iexact", s.Index(i).Interface(), "multi")
			}
		} else {
...
func (a *ProvidersAPIService) ProvidersSamlListExecute(r ApiProvidersSamlListRequest) (*PaginatedSAMLProviderList, *http.Response, error) {
	...
	if r.backchannelApplication != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "backchannel_application", r.backchannelApplication, "")
	}
	if r.defaultRelayState != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "default_relay_state", r.defaultRelayState, "")
	}
	...
	if r.isBackchannel != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "is_backchannel", r.isBackchannel, "")
	}
	if r.issuer != nil {
