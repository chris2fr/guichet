...
// checks if the PaginatedBlueprintInstanceList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedBlueprintInstanceList{}
...
func (o PaginatedBlueprintInstanceList) ToMap() (map[string]interface{}, error) {
