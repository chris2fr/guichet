...
// List of AppEnum
const (
	ADMIN AppEnum = "authentik.admin"
	API AppEnum = "authentik.api"
	CRYPTO AppEnum = "authentik.crypto"
	EVENTS AppEnum = "authentik.events"
	FLOWS AppEnum = "authentik.flows"
	OUTPOSTS AppEnum = "authentik.outposts"
	POLICIES_DUMMY AppEnum = "authentik.policies.dummy"
	POLICIES_EVENT_MATCHER AppEnum = "authentik.policies.event_matcher"
	POLICIES_EXPIRY AppEnum = "authentik.policies.expiry"
	POLICIES_EXPRESSION AppEnum = "authentik.policies.expression"
	POLICIES_PASSWORD AppEnum = "authentik.policies.password"
	POLICIES_REPUTATION AppEnum = "authentik.policies.reputation"
	POLICIES AppEnum = "authentik.policies"
	PROVIDERS_LDAP AppEnum = "authentik.providers.ldap"
	PROVIDERS_OAUTH2 AppEnum = "authentik.providers.oauth2"
	PROVIDERS_PROXY AppEnum = "authentik.providers.proxy"
	PROVIDERS_RADIUS AppEnum = "authentik.providers.radius"
	PROVIDERS_SAML AppEnum = "authentik.providers.saml"
	PROVIDERS_SCIM AppEnum = "authentik.providers.scim"
	RBAC AppEnum = "authentik.rbac"
	RECOVERY AppEnum = "authentik.recovery"
	SOURCES_LDAP AppEnum = "authentik.sources.ldap"
	SOURCES_OAUTH AppEnum = "authentik.sources.oauth"
	SOURCES_PLEX AppEnum = "authentik.sources.plex"
	SOURCES_SAML AppEnum = "authentik.sources.saml"
	STAGES_AUTHENTICATOR AppEnum = "authentik.stages.authenticator"
	STAGES_AUTHENTICATOR_DUO AppEnum = "authentik.stages.authenticator_duo"
	STAGES_AUTHENTICATOR_SMS AppEnum = "authentik.stages.authenticator_sms"
	STAGES_AUTHENTICATOR_STATIC AppEnum = "authentik.stages.authenticator_static"
	STAGES_AUTHENTICATOR_TOTP AppEnum = "authentik.stages.authenticator_totp"
	STAGES_AUTHENTICATOR_VALIDATE AppEnum = "authentik.stages.authenticator_validate"
	STAGES_AUTHENTICATOR_WEBAUTHN AppEnum = "authentik.stages.authenticator_webauthn"
	STAGES_CAPTCHA AppEnum = "authentik.stages.captcha"
	STAGES_CONSENT AppEnum = "authentik.stages.consent"
	STAGES_DENY AppEnum = "authentik.stages.deny"
	STAGES_DUMMY AppEnum = "authentik.stages.dummy"
	STAGES_EMAIL AppEnum = "authentik.stages.email"
	STAGES_IDENTIFICATION AppEnum = "authentik.stages.identification"
	STAGES_INVITATION AppEnum = "authentik.stages.invitation"
	STAGES_PASSWORD AppEnum = "authentik.stages.password"
	STAGES_PROMPT AppEnum = "authentik.stages.prompt"
	STAGES_USER_DELETE AppEnum = "authentik.stages.user_delete"
	STAGES_USER_LOGIN AppEnum = "authentik.stages.user_login"
	STAGES_USER_LOGOUT AppEnum = "authentik.stages.user_logout"
	STAGES_USER_WRITE AppEnum = "authentik.stages.user_write"
	TENANTS AppEnum = "authentik.tenants"
	BLUEPRINTS AppEnum = "authentik.blueprints"
	CORE AppEnum = "authentik.core"
	ENTERPRISE AppEnum = "authentik.enterprise"
)
