...
const (
	_1_1NAMEID_FORMATEMAIL_ADDRESS NameIdPolicyEnum = "urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"
	_2_0NAMEID_FORMATPERSISTENT NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:persistent"
	_2_0NAMEID_FORMATX509_SUBJECT_NAME NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:X509SubjectName"
	_2_0NAMEID_FORMATWINDOWS_DOMAIN_QUALIFIED_NAME NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName"
	_2_0NAMEID_FORMATTRANSIENT NameIdPolicyEnum = "urn:oasis:names:tc:SAML:2.0:nameid-format:transient"
)
