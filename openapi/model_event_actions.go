...
const (
	...
	LOGIN_FAILED EventActions = "login_failed"
	LOGOUT EventActions = "logout"
	USER_WRITE EventActions = "user_write"
	SUSPICIOUS_REQUEST EventActions = "suspicious_request"
	PASSWORD_SET EventActions = "password_set"
	SECRET_VIEW EventActions = "secret_view"
	SECRET_ROTATE EventActions = "secret_rotate"
	INVITATION_USED EventActions = "invitation_used"
	AUTHORIZE_APPLICATION EventActions = "authorize_application"
	SOURCE_LINKED EventActions = "source_linked"
	IMPERSONATION_STARTED EventActions = "impersonation_started"
	IMPERSONATION_ENDED EventActions = "impersonation_ended"
	FLOW_EXECUTION EventActions = "flow_execution"
	POLICY_EXECUTION EventActions = "policy_execution"
	POLICY_EXCEPTION EventActions = "policy_exception"
	PROPERTY_MAPPING_EXCEPTION EventActions = "property_mapping_exception"
	SYSTEM_TASK_EXECUTION EventActions = "system_task_execution"
	SYSTEM_TASK_EXCEPTION EventActions = "system_task_exception"
	SYSTEM_EXCEPTION EventActions = "system_exception"
	CONFIGURATION_ERROR EventActions = "configuration_error"
	MODEL_CREATED EventActions = "model_created"
	MODEL_UPDATED EventActions = "model_updated"
	MODEL_DELETED EventActions = "model_deleted"
	EMAIL_SENT EventActions = "email_sent"
	UPDATE_AVAILABLE EventActions = "update_available"
	CUSTOM EventActions = "custom_"
)
