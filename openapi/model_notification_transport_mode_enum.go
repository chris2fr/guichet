...
const (
	LOCAL NotificationTransportModeEnum = "local"
	WEBHOOK NotificationTransportModeEnum = "webhook"
	WEBHOOK_SLACK NotificationTransportModeEnum = "webhook_slack"
	EMAIL NotificationTransportModeEnum = "email"
)
