...
Other parameters are passed through a pointer to a apiSourcesLdapListRequest struct via the builder pattern
...
> LDAPSource SourcesLdapPartialUpdate(ctx, slug).PatchedLDAPSourceRequest(patchedLDAPSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesLdapPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedLDAPSourceRequest** | [**PatchedLDAPSourceRequest**](PatchedLDAPSourceRequest.md) |  | 
...
> LDAPSource SourcesLdapRetrieve(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesLdapRetrieveRequest struct via the builder pattern
...
> LDAPSource SourcesLdapUpdate(ctx, slug).LDAPSourceRequest(lDAPSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesLdapUpdateRequest struct via the builder pattern
...
> []UsedBy SourcesLdapUsedByList(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesLdapUsedByListRequest struct via the builder pattern
...
> OAuthSource SourcesOauthCreate(ctx).OAuthSourceRequest(oAuthSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthCreateRequest struct via the builder pattern
...
> SourcesOauthDestroy(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthDestroyRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesOauthListRequest struct via the builder pattern
...
> OAuthSource SourcesOauthPartialUpdate(ctx, slug).PatchedOAuthSourceRequest(patchedOAuthSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedOAuthSourceRequest** | [**PatchedOAuthSourceRequest**](PatchedOAuthSourceRequest.md) |  | 
...
> OAuthSource SourcesOauthRetrieve(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthRetrieveRequest struct via the builder pattern
...
> []SourceType SourcesOauthSourceTypesList(ctx).Name(name).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthSourceTypesListRequest struct via the builder pattern
...
> OAuthSource SourcesOauthUpdate(ctx, slug).OAuthSourceRequest(oAuthSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthUpdateRequest struct via the builder pattern
...
> []UsedBy SourcesOauthUsedByList(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesOauthUsedByListRequest struct via the builder pattern
...
> PlexSource SourcesPlexCreate(ctx).PlexSourceRequest(plexSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexCreateRequest struct via the builder pattern
...
> SourcesPlexDestroy(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexDestroyRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesPlexListRequest struct via the builder pattern
...
> PlexSource SourcesPlexPartialUpdate(ctx, slug).PatchedPlexSourceRequest(patchedPlexSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedPlexSourceRequest** | [**PatchedPlexSourceRequest**](PatchedPlexSourceRequest.md) |  | 
...
> RedirectChallenge SourcesPlexRedeemTokenCreate(ctx).PlexTokenRedeemRequest(plexTokenRedeemRequest).Slug(slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexRedeemTokenCreateRequest struct via the builder pattern
...
> PlexSource SourcesPlexRetrieve(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexRetrieveRequest struct via the builder pattern
...
> PlexSource SourcesPlexUpdate(ctx, slug).PlexSourceRequest(plexSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexUpdateRequest struct via the builder pattern
...
> []UsedBy SourcesPlexUsedByList(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesPlexUsedByListRequest struct via the builder pattern
...
> SAMLSource SourcesSamlCreate(ctx).SAMLSourceRequest(sAMLSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesSamlCreateRequest struct via the builder pattern
...
> SourcesSamlDestroy(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesSamlDestroyRequest struct via the builder pattern
...
func main() {
    ...
    authenticationFlow := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string |  (optional)
    bindingType := "bindingType_example" // string | * `REDIRECT` - Redirect Binding * `POST` - POST Binding * `POST_AUTO` - POST Binding with auto-confirmation (optional)
    ...
    managed := "managed_example" // string |  (optional)
    name := "name_example" // string |  (optional)
    nameIdPolicy := "nameIdPolicy_example" // string | NameID Policy sent to the IdP. Can be unset, in which case no Policy is sent.  * `urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress` - Email * `urn:oasis:names:tc:SAML:2.0:nameid-format:persistent` - Persistent * `urn:oasis:names:tc:SAML:2.0:nameid-format:X509SubjectName` - X509 * `urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName` - Windows * `urn:oasis:names:tc:SAML:2.0:nameid-format:transient` - Transient (optional)
    ordering := "ordering_example" // string | Which field to use when ordering the results. (optional)
    page := int32(56) // int32 | A page number within the paginated result set. (optional)
    pageSize := int32(56) // int32 | Number of results to return per page. (optional)
    policyEngineMode := "policyEngineMode_example" // string | * `all` - all, all policies must pass * `any` - any, any policy must pass (optional)
...
Other parameters are passed through a pointer to a apiSourcesSamlListRequest struct via the builder pattern
 ...
 **authenticationFlow** | **string** |  | 
 **bindingType** | **string** | * &#x60;REDIRECT&#x60; - Redirect Binding * &#x60;POST&#x60; - POST Binding * &#x60;POST_AUTO&#x60; - POST Binding with auto-confirmation | 
 ...
 **managed** | **string** |  | 
 **name** | **string** |  | 
 **nameIdPolicy** | **string** | NameID Policy sent to the IdP. Can be unset, in which case no Policy is sent.  * &#x60;urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress&#x60; - Email * &#x60;urn:oasis:names:tc:SAML:2.0:nameid-format:persistent&#x60; - Persistent * &#x60;urn:oasis:names:tc:SAML:2.0:nameid-format:X509SubjectName&#x60; - X509 * &#x60;urn:oasis:names:tc:SAML:2.0:nameid-format:WindowsDomainQualifiedName&#x60; - Windows * &#x60;urn:oasis:names:tc:SAML:2.0:nameid-format:transient&#x60; - Transient | 
 **ordering** | **string** | Which field to use when ordering the results. | 
 **page** | **int32** | A page number within the paginated result set. | 
 **pageSize** | **int32** | Number of results to return per page. | 
 **policyEngineMode** | **string** | * &#x60;all&#x60; - all, all policies must pass * &#x60;any&#x60; - any, any policy must pass | 
...
> SAMLMetadata SourcesSamlMetadataRetrieve(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesSamlMetadataRetrieveRequest struct via the builder pattern
...
> SAMLSource SourcesSamlPartialUpdate(ctx, slug).PatchedSAMLSourceRequest(patchedSAMLSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesSamlPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedSAMLSourceRequest** | [**PatchedSAMLSourceRequest**](PatchedSAMLSourceRequest.md) |  | 
...
> SAMLSource SourcesSamlRetrieve(ctx, slug).Execute()
...
Other parameters are passed through a pointer to a apiSourcesSamlRetrieveRequest struct via the builder pattern
...
> SAMLSource SourcesSamlUpdate(ctx, slug).SAMLSourceRequest(sAMLSourceRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesSamlUpdateRequest struct via the builder pattern
...
> []UsedBy SourcesSamlUsedByList(ctx, slug).Execute()
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **int32** | A unique integer value identifying this User OAuth Source Connection. | 

### Other Parameters

Other parameters are passed through a pointer to a apiSourcesUserConnectionsOauthDestroyRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsOauthListRequest struct via the builder pattern
...
> UserOAuthSourceConnection SourcesUserConnectionsOauthPartialUpdate(ctx, id).PatchedUserOAuthSourceConnectionRequest(patchedUserOAuthSourceConnectionRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsOauthPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **patchedUserOAuthSourceConnectionRequest** | [**PatchedUserOAuthSourceConnectionRequest**](PatchedUserOAuthSourceConnectionRequest.md) |  | 
...
> UserOAuthSourceConnection SourcesUserConnectionsOauthRetrieve(ctx, id).Execute()
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsOauthRetrieveRequest struct via the builder pattern
...
> UserOAuthSourceConnection SourcesUserConnectionsOauthUpdate(ctx, id).UserOAuthSourceConnectionRequest(userOAuthSourceConnectionRequest).Execute()
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsOauthUpdateRequest struct via the builder pattern
...
> []UsedBy SourcesUserConnectionsOauthUsedByList(ctx, id).Execute()
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsOauthUsedByListRequest struct via the builder pattern
...
> SourcesUserConnectionsPlexDestroy(ctx, id).Execute()
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **int32** | A unique integer value identifying this User Plex Source Connection. | 

### Other Parameters

Other parameters are passed through a pointer to a apiSourcesUserConnectionsPlexDestroyRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsPlexListRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsPlexPartialUpdateRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsPlexRetrieveRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiSourcesUserConnectionsPlexUpdateRequest struct via the builder pattern
...
> []UsedBy SourcesUserConnectionsPlexUsedByList(ctx, id).Execute()
