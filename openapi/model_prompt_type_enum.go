...
const (
	TEXT PromptTypeEnum = "text"
	TEXT_AREA PromptTypeEnum = "text_area"
	TEXT_READ_ONLY PromptTypeEnum = "text_read_only"
	TEXT_AREA_READ_ONLY PromptTypeEnum = "text_area_read_only"
	USERNAME PromptTypeEnum = "username"
	EMAIL PromptTypeEnum = "email"
	PASSWORD PromptTypeEnum = "password"
	NUMBER PromptTypeEnum = "number"
	CHECKBOX PromptTypeEnum = "checkbox"
	RADIO_BUTTON_GROUP PromptTypeEnum = "radio-button-group"
	DROPDOWN PromptTypeEnum = "dropdown"
	DATE PromptTypeEnum = "date"
	DATE_TIME PromptTypeEnum = "date-time"
	FILE PromptTypeEnum = "file"
	SEPARATOR PromptTypeEnum = "separator"
	HIDDEN PromptTypeEnum = "hidden"
	STATIC PromptTypeEnum = "static"
	AK_LOCALE PromptTypeEnum = "ak-locale"
)
