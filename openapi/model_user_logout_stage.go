...
// checks if the UserLogoutStage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserLogoutStage{}
...
func (o UserLogoutStage) ToMap() (map[string]interface{}, error) {
