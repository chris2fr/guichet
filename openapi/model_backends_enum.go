...
const (
	CORE_AUTH_INBUILT_BACKEND BackendsEnum = "authentik.core.auth.InbuiltBackend"
	CORE_AUTH_TOKEN_BACKEND BackendsEnum = "authentik.core.auth.TokenBackend"
	SOURCES_LDAP_AUTH_LDAP_BACKEND BackendsEnum = "authentik.sources.ldap.auth.LDAPBackend"
)
